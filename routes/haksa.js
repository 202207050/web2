...
//교수등록 페이지
router.get('/pro/insert', function(req, res){
    res.render('index.ejs', {title:'교수등록', pageName:'haksa/professors.ejs'});
});
...
router.post('/stu/insert', async function(req, res){
    ...
    try{
        ...
        await con.execute(sql, 
          {scode, sname, dept, birthday, year, advisor}, {autoCommit:true});
          res.sendStatus(200);
    }catch{
        res.sendStatus(500);
    }finally{
